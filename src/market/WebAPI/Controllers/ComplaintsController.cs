...
public class ComplaintsController : BaseController
{
    ...
    [HttpDelete("{id}")]
    public async Task<ActionResult<DeletedComplaintResponse>> Delete([FromRoute] int id)
    {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<GetByIdComplaintResponse>> GetById([FromRoute] int id)
    {

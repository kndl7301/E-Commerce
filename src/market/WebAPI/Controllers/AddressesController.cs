...
public class AddressesController : BaseController
{
    ...
    [HttpDelete("{id}")]
    public async Task<ActionResult<DeletedAddressResponse>> Delete([FromRoute] int id)
    {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<GetByIdAddressResponse>> GetById([FromRoute] int id)
    {
